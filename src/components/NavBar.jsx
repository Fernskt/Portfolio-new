...
export default function NavBar() {
 ...
 /*  useEffect(() => {
  ...
  // Cambia la clase del body cuando el estado de darkMode cambia
  useEffect(() => {
  ...
  return (
    <div className='navbar'>
      ...
      <button onClick={toggleDarkMode} title={darkMode ? 'light mode' : 'Dark Mode'}>
        {darkMode ? <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16">
