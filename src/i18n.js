...
const es = {
  ...
  contact: {
    ...
    form: {
      ...
      message:            "Mensaje",
      messagePlaceholder: "Contame sobre tu proyecto o idea…",
      send:               "Enviar mensaje",
      sending:            "Enviando…",
      successTitle:       "¡Mensaje enviado!",
      successText:        "Gracias por escribirme. Te respondo pronto.",
      sendAnother:        "Enviar otro",
      errorText:          "Algo salió mal. Por favor intentá de nuevo.",
      errors: {
