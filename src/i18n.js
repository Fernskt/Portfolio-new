...
const resources = {
  en: {
    translation: {
      ...
      "pjct-irish": "Irish Backoffice is a web application developed with Java Spring Boot and MySQL following the MVC pattern. Its primary objective is to efficiently manage and analyze claims, enabling different users (administrators and analysts) to interact with the information in a secure and scalable manner.",
