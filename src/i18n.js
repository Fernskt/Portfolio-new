...
const resources = {
  en: {
    translation: {
      ...
      "description": "Results-driven web developer who designs and manages digital platforms to drive overall product success.</span>",
      ...
      "pjct-movie": "Interactive web application to explore movie trailers, developed with React, Vite, Typescript, and Rsuite. Integrated with the TMDb API, it provides real-time access to titles, descriptions, ratings, and trailers.",
      ...
      "pjct-irish": "Irish Backoffice is a full-stack business application designed for comprehensive claims management. It is composed of a RESTful backend in Java Spring Boot with Spring Data JPA and MySQL, and a frontend built with React, React Router, React Query and Bootstrap.",
  ...
  es: {
    translation: {
      ...
      "pjct-movie": "Aplicación web interactiva para explorar trailers de películas, desarrollada con React, Vite, Typescript, y librerías como Rsuite. Integrada con la API de TMDb, ofrece acceso en tiempo real a títulos, descripciones, calificaciones y trailers",
      ...
      "pjct-irish": "Irish Backoffice Irish Backoffice es una aplicación empresarial full-stack diseñada para la gestión integral de siniestros. Está compuesta por: Backend RESTful en Java Spring Boot, con Spring Data JPA y MySQL. Frontend: React, React Router, React Query y Bootstrap",
